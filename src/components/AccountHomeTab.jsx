...
const AccountHomeTab = () => {
    ...
    return (
        <>
            <p className="account-alert"> <strong className="text-heading fw-500 text-poppins">{location.state.userData.username}</strong>  <strong className="text-heading fw-500 text-poppins">{userData.username}</strong> <Link to="/login">Log out</Link>  </p>
